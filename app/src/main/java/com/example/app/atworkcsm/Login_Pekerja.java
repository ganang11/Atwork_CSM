...
public class Login_Pekerja extends AppCompatActivity implements View.OnClickListener {
//    String status, message, code;
//    AuthService mAuthAPIService;
//    ProgressDialog progressDialog;
//    private GoogleApiClient client;
//    SessionManager sessionManager;
        Button bAbsen, bActivities;
...
//        final Activity activity = this;
        bAbsen = (Button) findViewById(R.id.b_Absensi);
        bActivities = (Button) findViewById(R.id.b_Activities);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.b_Absensi:
                Intent Absen = new Intent(Login_Pekerja.this, Absensi.class);
                startActivity(Absen);
                break;
