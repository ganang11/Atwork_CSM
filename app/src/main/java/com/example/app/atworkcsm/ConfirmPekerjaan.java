...
public class ConfirmPekerjaan extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_pekerjaan);

        Button selesai = (Button) findViewById(R.id.btn_selesai);

        sessionManager = new SessionManager(ConfirmPekerjaan.this);
        progressDialog = new ProgressDialog(ConfirmPekerjaan.this);
